...
Persona 还提供移动客户端，支持 iOS 和 Android，连接你的 Persona Agent Server 随时随地与 Agent 对话。
...
- 格式：PNG，推荐透明背景
- 建议尺寸：约 1000 × 2100
- 文件命名：`portrait.png`（默认）、`portrait-{expression}.png`（其他表情）
...
![背景示例](assets/background.png)

> 更多 Agent 形象资源，欢迎在 [GitHub Discussions](https://github.com/Code-MonkeyZhang/persona-agent/discussions) 分享和下载。
