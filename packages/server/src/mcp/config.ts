 ...
 *
 * Reads mcp.json from ~/.local/share/animus-agent/mcp/mcp.json and returns
 ...
 *
 * @param configPath - Optional custom path to mcp.json (default: ~/.local/share/animus-agent/mcp/mcp.json)
